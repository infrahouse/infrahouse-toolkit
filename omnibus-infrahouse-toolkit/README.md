infrahouse-toolkit Omnibus project
==================================
...
```shell
$ bin/omnibus build infrahouse-toolkit
```
...
```shell
$ bin/omnibus clean infrahouse-toolkit
```

Adding the `--purge` purge option removes __ALL__ files generated during the
build including the project install directory (`/opt/infrahouse-toolkit`) and
the package cache directory (`/var/cache/omnibus/pkg`):

```shell
$ bin/omnibus clean infrahouse-toolkit --purge
```
...
[vagrant@ubuntu...] $ cd infrahouse-toolkit   # or 'cd infrahouse-toolkit/omnibus' if your omnibus project is embedded in your main project
[vagrant@ubuntu...] $ bundle install
[vagrant@ubuntu...] $ bin/omnibus build infrahouse-toolkit
```
